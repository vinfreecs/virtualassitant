...
__all__ = [
    'SpeechDiscardType', 'ISpeechBaseStream',
    'DISPID_SGRsCommitAndSave', 'DISPID_SAFGetWaveFormatEx',
    'SVEPhoneme', 'SPRS_INACTIVE', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPACommit', 'DISPID_SVESentenceBoundary',
    'SGDSActiveUserDelimited', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPXRO_Alternates_SML', 'DISPID_SABIMinNotification',
    'SPBOOKMARKOPTIONS', 'SAFT48kHz8BitMono', 'eLEXTYPE_RESERVED7',
    'DISPID_SPIStartTime', 'SPAO_RETAIN_AUDIO',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVAlertBoundary',
    'SPEI_VISEME', 'SPPS_Interjection', 'DISPID_SGRSTWeight',
    ...
    'SAFT16kHz16BitStereo', 'DISPID_SGRSTNextState', 'SP_VISEME_5',
    'DISPID_SGRSTPropertyName',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechPhraseElements',
    'SREFalseRecognition', 'SAFTNonStandardFormat', 'DISPID_SLPsItem',
    ...
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'Speech_Default_Weight',
    'DISPID_SVAudioOutput', 'eWORDTYPE_ADDED', 'SAFT24kHz8BitStereo',
    'SRSInactiveWithPurge', 'SpMMAudioIn', 'SAFT8kHz8BitMono',
    ...
    'SAFT48kHz8BitStereo', 'SpeechVisemeType', 'DISPID_SRCPause',
    'SpeechTokenContext', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVStatus', 'SECFIgnoreKanaType', 'IEnumSpObjectTokens',
    'UINT_PTR', 'eLEXTYPE_PRIVATE9', 'SPAUDIOSTATE',
    'DISPID_SpeechRecoContextEvents', 'SPAUDIOSTATUS',
    'SpeechWordPronounceable', 'SpeechPropertyLowConfidenceThreshold',
    'SPPHRASE', 'DISPID_SpeechObjectTokens',
    'SAFTExtendedAudioFormat', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPEAudioStreamOffset',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT32kHz16BitStereo',
    'SVEBookmark', 'SPCT_SUB_COMMAND', 'SP_VISEME_10',
    'DISPID_SMSSetData', 'SVEEndInputStream', 'SPWORDPRONOUNCEABLE',
    'SREStateChange', 'SVSFPersistXML',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPAPhraseInfo',
    'DISPID_SRGRules', 'SASRun', 'eLEXTYPE_PRIVATE13', 'SP_VISEME_16',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPSEMANTICFORMAT',
    'SpeechTokenKeyUI', 'DISPID_SPRuleConfidence', 'SPPARTOFSPEECH',
    'SVP_0', 'SPEI_PHRASE_START', 'SpMMAudioEnum', 'WAVEFORMATEX',
    'DISPID_SPIEngineId', 'SINoise', 'eLEXTYPE_PRIVATE3', 'SAFTText',
    'ISpNotifySource', 'SAFTGSM610_8kHzMono', 'SPLO_DYNAMIC',
    'DISPID_SGRSAddRuleTransition', 'Speech_StreamPos_RealTime',
    'DISPID_SpeechPhraseReplacement', 'SAFT24kHz8BitMono',
    'SPRST_NUM_STATES', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SDKSetLongValue', 'SREAllEvents',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPEsItem', 'ISpeechLexicon', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechMMSysAudio', 'SREInterference', 'SP_VISEME_21',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPEAudioSizeTime',
    'SAFT22kHz8BitMono', 'SECFEmulateResult',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRGetPropertyString',
    'SDKLDefaultLocation', 'SAFTCCITT_ALaw_22kHzStereo', 'SINoSignal',
    'SPAUDIOBUFFERINFO', 'DISPID_SRGetFormat', 'SAFT11kHz8BitMono',
    'ISpeechRecoResultDispatch', 'SPCS_ENABLED', 'SVP_9',
    'SAFT48kHz16BitStereo', 'SPCT_SUB_DICTATION', 'SpLexicon',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVEAllEvents', 'SPEVENT',
    'DISPID_SGRsDynamic', 'ISpeechPhraseAlternates', 'ISpeechAudio',
    'DISPID_SPCLangId', 'SGRSTTDictation', 'SPEI_RESERVED6',
    'DISPID_SDKGetBinaryValue', 'SP_VISEME_18', 'SVF_Stressed',
    'DISPID_SWFEBlockAlign', 'DISPID_SOTsCount', 'SPXRO_SML',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_PRIVATE1', 'SPPS_Unknown',
    'SECFIgnoreCase', 'DISPID_SABIBufferSize', 'SVP_18',
    'SPWORDPRONUNCIATION', 'SPSHT_OTHER',
    'DISPID_SPIAudioStreamPosition', 'SPFM_CREATE', 'SPFM_NUM_MODES',
    'SVP_5', 'DISPID_SAFGuid', 'ISpXMLRecoResult',
    'SAFT24kHz16BitMono', 'DISPID_SVGetProfiles',
    'DISPID_SOTCDefault', 'DISPID_SGRs_NewEnum',
    'ISpeechXMLRecoResult', 'SPPS_Function', 'SpeechRuleState',
    'DISPID_SVEViseme', 'SRERequestUI', 'SVSFParseSsml',
    'SAFT22kHz16BitStereo', 'SECNormalConfidence',
    ...
    'DISPID_SRGetRecognizers', 'ISpeechLexiconWords', 'SPVPRI_OVER',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'STCAll',
    'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE4', 'SPPHRASEPROPERTY',
    'SPEI_VOICE_CHANGE', 'ISpEventSink', 'SpeechVoiceSpeakFlags',
    'DISPIDSPTSI_SelectionLength', 'SVSFNLPSpeakPunc',
    'SGDSActiveWithAutoPause', 'SpeechEngineProperties',
    'DISPID_SOTCEnumerateTokens', 'SAFT8kHz16BitMono',
    'DISPID_SRCEHypothesis', 'SLTApp', 'SITooQuiet',
    'DISPID_SDKEnumValues', 'ISpeechPhraseRules',
    'DISPID_SGRSTsCount', 'SPFILEMODE', 'SpCustomStream',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRGCommit',
    'SAFTNoAssignedFormat', 'DISPID_SGRSTText', 'DISPID_SGRsAdd',
    'ISpeechRecoGrammar', 'SRADynamic', 'DISPID_SRCEEndStream',
    'SSFMOpenReadWrite', 'ISpeechGrammarRuleState',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFT16kHz16BitMono',
    'SPSInterjection', 'eLEXTYPE_RESERVED8', 'SGDSActive',
    'SDTDisplayText', 'SINone', 'SGRSTTWord',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_MIN_SR',
    'DISPID_SPRules_NewEnum', 'ISpObjectToken',
    'SAFT24kHz16BitStereo', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE20',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechFormatType', 'SRSInactive',
    'SpResourceManager', 'SASPause', 'SPCONTEXTSTATE',
    'DISPID_SLPsCount', 'DISPID_SVEBookmark',
    'DISPID_SpeechRecoResult', 'SAFTADPCM_44kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRERecognition',
    'DISPID_SOTId', 'SDKLCurrentConfig', 'DISPID_SLAddPronunciation',
    'DISPID_SPPEngineConfidence', 'SPRULE', 'SPPS_NotOverriden',
    'SPPS_LMA', 'SPGRAMMARSTATE', 'DISPID_SDKGetlongValue',
    'DISPID_SPEs_NewEnum', 'SRATopLevel', 'SSSPTRelativeToStart',
    'DISPID_SRGIsPronounceable', 'SPSUnknown',
    'SpUnCompressedLexicon', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPEPronunciation', 'SPSNoun', 'SRTStandard',
    'SAFT11kHz8BitStereo', 'SAFTGSM610_11kHzMono',
    'DISPID_SPRulesItem', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SAStatus', 'DISPID_SVGetAudioOutputs',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechGrammarState',
    'DISPID_SPRuleNumberOfElements', 'SPAS_RUN', 'SAFT22kHz16BitMono',
    'ISpeechGrammarRules', 'SpeechTokenShellFolder', 'SRSEDone',
    'ISpeechTextSelectionInformation', 'SGRSTTWildcard',
    'tagSPTEXTSELECTIONINFO', 'ISpeechPhraseRule',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SAEventHandle',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechCustomStream', 'SVEWordBoundary', 'SVEAudioLevel',
    'SpeechAudioFormatType', '_ISpeechVoiceEvents',
    'ISpeechRecognizer', 'SPWF_SRENGINE', 'SREAdaptation',
    'SRCS_Enabled', 'DISPID_SOTGetDescription', 'DISPID_SLWWord',
    'SpSharedRecognizer', 'SPRST_INACTIVE',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_SOUND_END',
    'SREPropertyStringChange', 'IInternetSecurityMgrSite', 'SVP_20',
    'DISPID_SPIRule', 'SpeechTokenValueCLSID', 'SPSERIALIZEDRESULT',
    'DISPID_SRDisplayUI', 'DISPID_SRSCurrentStreamPosition', 'SVP_11',
    'DISPID_SRCEStartStream', 'SPSNotOverriden', 'SPWF_INPUT',
    'DISPID_SVVolume', 'DISPID_SPRuleChildren', 'SGPronounciation',
    'SpeechRecoEvents', 'SVEPrivate', 'SPBO_PAUSE',
    'DISPID_SGRSTPropertyId', 'DISPID_SRGState', 'DISPID_SPPsCount',
    'SPAS_PAUSE', 'STSF_FlagCreate', 'DISPID_SPISaveToMemory',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE18',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SBSRead',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPCT_COMMAND',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCRetainedAudio', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPPNumberOfElements', 'DISPID_SPRsItem',
    'SSFMOpenForRead', 'SASStop', 'DISPID_SRIsShared',
    'SpeechRecoContextState', 'DISPID_SPPChildren',
    'DISPID_SDKCreateKey', 'SpCompressedLexicon',
    'DISPID_SRSAudioStatus', 'DISPID_SWFEChannels',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechGrammarRule',
    'SPPS_RESERVED4', '_ISpeechRecoContextEvents', 'SVEVoiceChange',
    'SAFTGSM610_22kHzMono', 'DISPID_SRRPhraseInfo',
    'SpeechCategoryPhoneConverters', 'SPAR_Medium', 'SPAR_Low',
    'DISPID_SOTCategory', 'SPINTERFERENCE_NOISE', 'SPSMF_UPS',
    'SP_VISEME_17', 'DISPID_SPPParent',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCEAudioLevel',
    'SpeechWordType', 'DISPID_SVIsUISupported', 'DISPID_SFSClose',
    'DISPID_SpeechGrammarRules', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCVoice', 'SAFT16kHz8BitStereo', 'SpeechAudioProperties',
    'DISPID_SGRsCount', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechSpecialTransitionType', 'SREPhraseStart',
    ...
    'DISPID_SpeechPhraseRule', 'SVP_12', 'SAFTDefault',
    'SpeechGrammarWordType', 'SREHypothesis', 'ISpRecognizer3',
    'DISPID_SPAs_NewEnum', 'SpeechRegistryUserRoot', 'ISpRecoContext',
    'STCInprocServer', 'DISPID_SLWs_NewEnum', 'SAFT11kHz16BitStereo',
    'DISPID_SPAStartElementInResult', 'DISPID_SVSpeak',
    'SRTSMLTimeout', 'ISpeechPhraseInfo', 'eLEXTYPE_RESERVED10',
    'SpeechVoiceSkipTypeSentence', 'SECFIgnoreWidth',
    'DISPID_SVEEnginePrivate', 'ISpeechObjectToken', 'SDTReplacement',
    'SRAImport', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRSAddWordTransition', 'SpeechDataKeyLocation',
    'DISPID_SRRSaveToMemory', 'DISPID_SABufferNotifySize',
    'STSF_CommonAppData', 'eLEXTYPE_PRIVATE8',
    'SDA_No_Trailing_Space', 'ISpRecoGrammar', 'SDKLLocalMachine',
    'eLEXTYPE_PRIVATE19', 'SPDKL_CurrentUser', 'SVSFNLPMask',
    'ISpeechRecoResult', 'DISPID_SpeechAudioFormat',
    'DISPID_SAVolume', 'SP_VISEME_11', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SDKEnumKeys', 'SpAudioFormat', 'SPEI_SR_PRIVATE',
    'DISPID_SRCEAdaptation', 'SPEVENTENUM', 'ISpeechFileStream',
    'SVP_3', 'DISPID_SGRName', 'SP_VISEME_7',
    'DISPID_SpeechPhraseAlternate', 'ISpeechRecoContext',
    'DISPID_SpeechDataKey', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRRSetTextFeedback', 'SPEI_UNDEFINED',
    'ISpeechLexiconWord', 'ISpDataKey', 'SGDSInactive',
    'DISPID_SLWsCount', 'DISPID_SGRsItem', 'DISPID_SOTCreateInstance',
    'SP_VISEME_9', 'tagSPPROPERTYINFO', 'DISPID_SRGDictationUnload',
    'DISPID_SPARecoResult', 'SP_VISEME_8',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSkip',
    'DISPID_SPEActualConfidence', 'SWPUnknownWordUnpronounceable',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SASState', 'SpPhoneticAlphabetConverter',
    'SPPS_RESERVED1', 'SWPUnknownWordPronounceable',
    'SPEI_INTERFERENCE', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechVoiceStatus', 'SBOPause', 'ISpeechPhraseProperties',
    'SPSHT_Unknown', 'SDTLexicalForm', 'DISPID_SADefaultFormat',
    'DISPID_SGRSRule', 'ISpeechObjectTokens', 'SPAR_High',
    'eLEXTYPE_PRIVATE10', 'DISPID_SLGetWords', 'SPEI_SR_BOOKMARK',
    'eLEXTYPE_PRIVATE14', 'DISPID_SMSGetData', 'SAFTADPCM_22kHzMono',
    'DISPID_SPEEngineConfidence', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRRSpeakAudio', 'SPCS_DISABLED',
    'SpeechGrammarTagWildcard', 'SAFT16kHz8BitMono', 'SPRS_ACTIVE',
    'SP_VISEME_0', 'DISPID_SRCResume', 'SpStreamFormatConverter',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCCreateGrammar',
    'SRTReSent', 'DISPID_SBSWrite', 'DISPID_SWFESamplesPerSec',
    'DISPID_SGRId', 'ISpPhraseAlt',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRTStreamTime',
    'SpeechRecognitionType', 'SAFTTrueSpeech_8kHz1BitMono',
    'SECHighConfidence', 'SPSLMA', 'SPINTERFERENCE',
    'SpInProcRecoContext', 'SDTRule', 'SGLexicalNoSpecialChars',
    'SPWT_LEXICAL', 'SAFTADPCM_22kHzStereo', 'SpeechStreamFileMode',
    'ISpGrammarBuilder', 'IStream', 'DISPID_SpeechRecognizerStatus',
    'SpTextSelectionInformation', 'STCRemoteServer',
    'SpeechStreamSeekPositionType', 'DISPID_SFSOpen',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRRRecoContext',
    'DISPID_SVPause', 'DISPID_SRGDictationSetState',
    'SPGRAMMARWORDTYPE', 'SAFTCCITT_uLaw_8kHzStereo',
    'Speech_StreamPos_Asap', 'ISpeechPhraseReplacement',
    'SP_VISEME_12', 'SPEI_RESERVED5', 'DISPID_SGRSTType',
    'SAFTADPCM_11kHzMono', 'SAFTGSM610_44kHzMono', 'SLTUser',
    'SPAS_STOP', 'ISpeechLexiconPronunciation',
    'DISPID_SASCurrentDevicePosition', 'SPAUDIOOPTIONS',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_11kHzStereo', 'SPCT_SLEEP',
    'DISPID_SpeechLexiconWords', 'SpeechAddRemoveWord',
    'SP_VISEME_14', 'SpeechRecognizerState', 'SP_VISEME_15',
    'SRERecoOtherContext', 'SPSHORTCUTPAIRLIST',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechPhraseRules',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE5',
    'DISPID_SLRemovePronunciation', 'SPWORDTYPE', 'SpShortcut',
    'SPLOADOPTIONS', 'ISpStream', 'SREAudioLevel',
    'DISPID_SpeechLexiconWord', 'DISPID_SRRecognizer',
    'DISPID_SRCEEnginePrivate', 'SPLO_STATIC', 'SITooSlow',
    'DISPID_SOTCId', 'eLEXTYPE_PRIVATE2', 'SPEI_ADAPTATION',
    'DISPID_SPEsCount', 'DISPID_SGRSTsItem',
    'DISPID_SVSInputSentenceLength', 'SpeechCategoryAudioOut',
    'DISPID_SpeechObjectTokenCategory', 'SPBO_TIME_UNITS',
    'SVSFParseAutodetect', 'SVP_19', 'SVSFIsFilename',
    ...
    'DISPID_SpeechPhraseElements', 'SPPS_RESERVED3', 'SFTSREngine',
    'SRTAutopause', 'SDTAll', 'DISPID_SVSLastBookmarkId',
    ...
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SLGetGenerationChange',
    'ISpSerializeState', 'DISPID_SPRuleName', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCESoundStart', 'DISPID_SBSSeek',
    'DISPID_SpeechFileStream', 'SVP_6', 'SpeechTokenKeyFiles',
    'SPWT_DISPLAY', 'SAFT44kHz8BitStereo', 'DISPID_SLWType',
    'DISPID_SVEventInterests', 'SECFNoSpecialChars',
    'SPEI_SOUND_START', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVDisplayUI', 'SVP_15', 'SpObjectTokenCategory',
    'DISPID_SPRText', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechRecognizerStatus', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEPhoneme', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPCIdToPhone',
    'SRTEmulated', 'SPRULESTATE', 'DISPID_SRIsUISupported',
    'ISpRecoGrammar2', 'DISPID_SRCState', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVRate', 'DISPID_SRCERecognizerStateChange',
    ...
    'DISPID_SpeechObjectToken', 'IEnumString', 'SPWAVEFORMATTYPE',
    'SPPS_Noun', 'DISPID_SWFEBitsPerSample', 'SPWORDLIST',
    'SPPS_Noncontent', 'SVSFPurgeBeforeSpeak', 'DISPID_SMSALineId',
    'SWTDeleted', 'SpeechCategoryAppLexicons', 'SGSExclusive',
    'SLODynamic', 'DISPID_SLWsItem', 'DISPID_SPIElements',
    'SPDKL_LocalMachine', 'eLEXTYPE_RESERVED6', 'SPEI_TTS_BOOKMARK',
    'SpVoice', 'SBONone', 'DISPID_SOTDataKey', 'DISPID_SGRClear',
    'SVP_1', 'SpeechAudioState', 'DISPID_SpeechPhraseReplacements',
    'SDKLCurrentUser', 'SPBO_NONE', 'DISPID_SpeechAudioStatus',
    'DISPID_SPRFirstElement', 'SpeechRunState',
    'DISPID_SLGenerationId', 'DISPID_SRRGetXMLResult', 'STSF_AppData',
    'SREStreamEnd', 'SVSFVoiceMask', 'DISPID_SOTRemove',
    'SpeechCategoryVoices', 'SPVPRIORITY', 'SPPS_SuppressWord',
    'SGSEnabled', 'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_USER_SHORTCUT',
    'SVEViseme', 'DISPID_SRRAudio', 'SPRST_ACTIVE',
    'SPEI_WORD_BOUNDARY', 'DISPID_SCSBaseStream',
    'SpeechRegistryLocalMachineRoot', 'SpPhraseInfoBuilder',
    'ISpeechDataKey', 'DISPID_SRCBookmark', 'SVSFIsNotXML',
    'SAFTCCITT_ALaw_11kHzMono', '_RemotableHandle',
    'DISPID_SRGRecoContext', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPPS_Verb', 'SPEI_MAX_TTS',
    'DISPID_SPRsCount', 'SPPS_RESERVED2', 'ISpeechPhoneConverter',
    'SLOStatic', 'SPSMF_SAPI_PROPERTIES', 'SAFT8kHz8BitStereo',
    'DISPID_SRRTTickCount', 'SAFT48kHz16BitMono',
    'SPINTERFERENCE_TOOQUIET', 'SPGS_DISABLED',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SOTCSetId',
    'ISpRecoCategory', 'DISPID_SPPValue', 'ISpShortcut',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVGetVoices',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechPhraseAlternates', 'SPCATEGORYTYPE',
    'DISPID_SGRInitialState', 'SPAO_NONE',
    'DISPID_SOTRemoveStorageFileName', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPEI_RECOGNITION', 'SpNullPhoneConverter', 'DISPID_SPPs_NewEnum',
    'SAFT44kHz8BitMono', 'SPRS_ACTIVE_USER_DELIMITED', 'SVP_21',
    'DISPID_SGRSTransitions', 'DISPID_SPRs_NewEnum',
    'DISPID_SABIEventBias', 'DISPID_SpeechPhraseProperties',
    'ISpeechCustomStream', 'SP_VISEME_13',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVVoice',
    'SpeechAllElements', 'DISPID_SRCRecognizer', 'SGSDisabled',
    'SPSEMANTICERRORINFO', 'SPAR_Unknown', 'ISpObjectWithToken',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSFunction',
    'DISPID_SRRAlternates', 'SpMMAudioOut', 'eLEXTYPE_APP',
    'DISPID_SVSPhonemeId', 'DISPID_SRGReset',
    'SAFTCCITT_uLaw_44kHzStereo', 'SRAORetainAudio',
    'SRADefaultToActive', 'SPDKL_DefaultLocation', 'SVP_16',
    'SDTProperty', 'SPBO_AHEAD', 'DISPID_SAFType',
    'DISPID_SPRulesCount', 'SpStream', 'SGRSTTTextBuffer',
    'SpeechVoiceCategoryTTSRate', 'ISpRecoContext2', 'SVSFParseSapi',
    'ISpeechPhraseInfoBuilder', 'SVSFParseMask', 'eLEXTYPE_PRIVATE11',
    'DISPID_SVEAudioLevel', 'DISPID_SRCRequestedUIType',
    'DISPID_SPRNumberOfElements', 'DISPID_SPEDisplayText',
    'DISPID_SPPConfidence', 'DISPID_SRCERecognition',
    'DISPID_SVAudioOutputStream', 'SITooLoud',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRSetPropertyNumber',
    'SPWORD', 'LONG_PTR', 'SVPAlert', 'DISPID_SRAudioInput',
    'SREPrivate', 'ISpeechRecoResult2', 'DISPID_SRCEPhraseStart',
    'SVSFIsXML', 'SPVOICESTATUS', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPRuleId', 'STCInprocHandler', 'SPGS_EXCLUSIVE',
    'SRAExport', 'SECLowConfidence', 'SPEI_PROPERTY_NUM_CHANGE',
    'SRSActive', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SRRTimes',
    'DISPID_SVSCurrentStreamNumber', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_RESERVED1', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRSSupportedLanguages', 'SVP_8', 'SPRECOSTATE',
    'SPSModifier', 'Speech_Max_Word_Length',
    'DISPID_SVSInputWordPosition', 'SPVPRI_ALERT', 'eLEXTYPE_USER',
    'DISPID_SPELexicalForm', 'DISPID_SRGSetWordSequenceData',
    'SpeechDisplayAttributes', 'DISPID_SpeechVoice', 'SPLEXICONTYPE',
    'SPPHRASEELEMENT', 'SPEI_MAX_SR', 'SSTTDictation',
    'ISpStreamFormat', 'SPEI_TTS_AUDIO_LEVEL', 'SVF_Emphasis',
    'DISPID_SRStatus', 'ISpPhoneConverter', 'SVP_17',
    'SSTTTextBuffer', 'STSF_LocalAppData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SBSFormat', 'DISPID_SLPType', 'DISPID_SRRTLength',
    'SDA_One_Trailing_Space', 'ISpNotifySink',
    'SDA_Consume_Leading_Spaces', 'SRESoundStart', 'DISPID_SPPName',
    'SPEI_START_INPUT_STREAM', 'eLEXTYPE_PRIVATE15', 'ISpLexicon',
    'SPRECORESULTTIMES', 'DISPID_SABufferInfo', 'SPXMLRESULTOPTIONS',
    'SPAS_CLOSED', 'IInternetSecurityManager', 'DISPID_SVPriority',
    'SECFDefault', 'ISpAudio', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpStreamFormatConverter', 'DISPIDSPTSI', 'SAFT32kHz8BitMono',
    ...
    'DISPID_SDKDeleteValue', 'SRARoot', 'SWTAdded',
    'DISPID_SPERequiredConfidence', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SOTGetAttribute', 'SPSHT_EMAIL', 'ISpRecoResult',
    'SRESoundEnd', 'ISpeechPhraseReplacements',
    'DISPID_SpeechGrammarRuleState', 'SPSHT_NotOverriden',
    'SPEI_RESERVED3', 'DISPID_SRCESoundEnd', 'SREBookmark', 'SVP_10',
    'DISPID_SPAsCount', 'SPFM_OPEN_READONLY',
    'DISPID_SVSRunningState', 'SVP_13', 'ISpeechPhraseAlternate',
    'DISPID_SRCSetAdaptationData', 'SPSERIALIZEDPHRASE',
    'SpeechBookmarkOptions', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SLGetPronunciations',
    'SPBINARYGRAMMAR', 'DISPID_SVSpeakStream', 'SP_VISEME_4',
    'SREStreamStart', 'SPSVerb', 'SpeechVoiceEvents',
    'SPSHORTCUTPAIR', 'SpNotifyTranslator', 'DISPID_SPRuleParent',
    'DISPID_SWFEFormatTag', 'SpeechTokenKeyAttributes',
    ...
    'SAFTADPCM_11kHzStereo', 'SPGS_ENABLED', 'eWORDTYPE_DELETED',
    'SREPropertyNumChange', 'SVSFDefault', 'SVPNormal', 'SITooFast',
    'DISPID_SpeechMemoryStream', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRSCurrentStreamNumber', 'SpMemoryStream',
    'SAFT11kHz16BitMono', 'ISpeechAudioFormat',
    'DISPID_SRSClsidEngine', 'SpObjectToken', 'DISPID_SRGId',
    ...
    'SDTAudio', 'SAFT12kHz16BitMono', 'SGDisplay', 'SPSSuppressWord',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_START_SR_STREAM',
    'SPEI_RESERVED2', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SOTCGetDataKey',
    'DISPID_SRCEBookmark', 'DISPID_SLPs_NewEnum', 'DISPIDSPRG',
    'SpeechLexiconType', 'DISPID_SpeechAudio', 'DISPID_SGRSTRule',
    'ISpRecognizer2', 'SPDATAKEYLOCATION', 'SP_VISEME_3',
    'SPEI_HYPOTHESIS', 'DISPID_SRCERequestUI', 'ISpeechMemoryStream',
    'SVSFlagsAsync', 'DISPID_SPIGrammarId', 'DISPID_SGRAttributes',
    'SP_VISEME_20', 'Speech_Max_Pron_Length', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT32kHz8BitStereo', 'SFTInput', 'DISPID_SVSInputWordLength',
    'SpeechAudioFormatGUIDText', 'DISPID_SLWPronunciations',
    'SPPS_Modifier', 'ISpResourceManager',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SDKDeleteKey', 'SVP_4',
    ...
    'SGRSTTRule', 'SPPHRASERULE', 'SDTAlternates',
    'SWPKnownWordPronounceable',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SSTTWildcard',
    'SPWT_PRONUNCIATION', 'SPEI_PHONEME', 'SPEI_END_SR_STREAM',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechRecoResult2', 'SRCS_Disabled', 'DISPID_SDKOpenKey',
    'SpeechRuleAttributes', 'SVF_None', 'SAFTADPCM_8kHzStereo',
    'SPCT_DICTATION', 'DISPID_SLPSymbolic', 'ISpMMSysAudio',
    'SRSEIsSpeaking', 'DISPID_SpeechVoiceEvent', 'SP_VISEME_6',
    'SAFT22kHz8BitStereo', 'DISPID_SPIProperties', 'DISPID_SOTSetId',
    'SpeechEngineConfidence', 'DISPID_SDKSetStringValue',
    'SpFileStream', 'ISpeechResourceLoader', 'SRAONone', 'SGLexical',
    'SSFMCreate', 'DISPID_SPERetainedSizeBytes', 'ISpEventSource',
    'SSFMCreateForWrite', 'DISPID_SpeechRecognizer',
    'DISPID_SRGDictationLoad', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_PRIVATE17', 'SpeechVoicePriority', 'ISequentialStream',
    'DISPID_SpeechPhraseInfo', 'SpeechGrammarTagDictation',
    'DISPID_SRGCmdSetRuleState', 'STCLocalServer',
    'ISpeechAudioStatus', 'SRSActiveAlways',
    'DISPID_SOTGetStorageFileName',
    'DISPID_SRCAudioInInterferenceStatus', 'SpWaveFormatEx',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE6', '_SPAUDIOSTATE',
    'SPTEXTSELECTIONINFO', 'SVPOver', 'DISPID_SLPLangId',
    'SpInprocRecognizer', 'SVESentenceBoundary', 'SPVISEMES',
    'ISpPhrase', 'SAFTCCITT_ALaw_8kHzMono', 'SPEI_MIN_TTS',
    'eLEXTYPE_PRIVATE12', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE7',
    'ISpProperties', 'DISPID_SVWaitUntilDone', 'DISPID_SPPsItem',
    'DISPID_SGRAddResource', 'DISPID_SGRsFindRule',
    'DISPID_SRSetPropertyString', 'SAFT44kHz16BitMono',
    'DISPID_SRRAudioFormat', 'ISpeechWaveFormatEx',
    'DISPID_SLWLangId', 'DISPID_SRAudioInputStream', 'SRAInterpreter',
    'ISpeechPhraseElement', 'SVSFUnusedFlags',
    'DISPID_SVSLastBookmark', 'DISPID_SGRSTPropertyValue',
    'SP_VISEME_19', 'ISpeechLexiconPronunciations',
    'SpPhoneConverter', 'SpeechUserTraining',
    'ISpeechObjectTokenCategory', 'DISPID_SOTMatchesAttributes',
    'SpeechInterference', 'SPPROPERTYINFO', 'SPFM_CREATE_ALWAYS',
    'SpSharedRecoContext', 'ISpVoice', 'SPVPRI_NORMAL',
    'DISPID_SDKGetStringValue', 'SPPHRASEREPLACEMENT', 'tagSTATSTG',
    'SP_VISEME_2', 'DISPID_SVEStreamStart', 'SVP_7',
    'DISPID_SVEStreamEnd', 'SDTPronunciation',
    'DISPID_SRRDiscardResultInfo', 'SpeechLoadOption',
    'SPEI_REQUEST_UI', 'ISpRecognizer', 'DISPID_SGRsCommit',
    'SpeechPartOfSpeech', 'ISpeechVoice', 'DISPID_SPIGetText',
    'DISPID_SVEWord', 'SASClosed'
]
